  ...
  <div class="employee">
    ...
    <div class="gridTable">
      <zj-table :autoHeight='bottomDivShow' ref="taskTable" style="width: 100%;" height='250px' :data="taskData"
        ...
        <el-table-column prop="emp_id" label="序号" align="center" width="100"></el-table-column>

        <el-table-column prop="emp_no" label="工号" align="center" width="100"></el-table-column>

        <el-table-column prop="emp_name" label="人员名称" align="center" width="130"></el-table-column>
        ...
        <el-table-column prop="emp_state" label="状态" align="center" width="130">
          <template slot-scope="scope">
    ...
    <el-dialog v-if="addEmpVisiable" v-dialogDrag width="450px" :title="addEmpText" :close-on-click-modal="false"
      ...
      <zj-form size="small" :newDataFlag='addEmpVisiable' :model="empModel" label-width="100px" ref="empForm"
        ...
        <el-form-item label="人员名称" prop="emp_name">
          <el-input class="formItem" v-model="empModel.emp_name" placeholder="请填写人员名称">
          </el-input>
        </el-form-item>

        <el-form-item label="性别">
          <el-select v-model="empModel.sex_type" placeholder="请选择性别类型">
            <el-option v-for="item in empSex_options" :key="item.value" :label="item.label" :value="item.value">
            </el-option>
          </el-select>
        </el-form-item>
        ...
        <el-form-item label="在职状态">
          <el-select v-model="empModel.state_type" placeholder="请选择在职状态">
            <el-option v-for="item in empState_options" :key="item.value" :label="item.label" :value="item.value">
            </el-option>
          </el-select>
        </el-form-item>
    ...
    <el-dialog v-dialogDrag width="450px" :title="addSkillText" :close-on-click-modal="false"
      ...
      <zj-form size="small" :newDataFlag='skillFormVisible' :model="skillModel" label-width="100px" ref="skillForm"
        ...
        <el-form-item label="评定时间" prop="se_givedate">
          <el-input v-model="skillModel.givedate" autocomplete="off" placeholder="请填写评定时间">
          </el-input>
        </el-form-item>
  ...
  data() {
    return {
      ...
      addSkill_rules: {
        ...
        cc_id: [{ required: true, message: "请选择技能等级", trigger: "blur" }],
        sl_id:[{ required: false, message: "请选择技能等级", trigger: "blur" }],
        se_giveperson:[{ required: false, message: "请选择技能等级", trigger: "blur" }],
        se_givedate:[{ required: false, message: "请选择技能等级", trigger: "blur" }],
      }
    };
  },
